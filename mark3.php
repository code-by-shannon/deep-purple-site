<?php
$comment_table = 'comments_mark3';
include 'includes/comment_logic.php';
define('PAGE_TITLE', 'Mark II - Deep Purple - Hughes, Coverdale era');
?>
...
<h3 class='album_title_header'>Burn - <em>1974</em></h3><img class="album_cover" src="imgs/cover_burn.png" alt="Burn Cover"/>
<p class='review_text'>
...
<span class="rating"> (rating: 5/5 whammy bars)</span></p>
<p>🎧 Songs that didn't make the album that you should definitely listen to:<b> Coranarias Redig</b></p> 
</div>
...
<!--Stormbringer-->
<div class='title_cover_review_rating_div'>
<h3 class='album_title_header'>Stormbringer - <em>1974</em></h3><img class="album_cover" src="imgs/cover_stormbringer.png" alt="Stormbringer Cover"/> 
<p class='review_text'>
